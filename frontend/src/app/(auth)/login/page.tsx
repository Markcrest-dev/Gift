            ...
            <div className="w-full lg:w-1/2 lg:ml-auto flex flex-col items-center justify-center h-screen p-4 sm:p-6 relative z-10">
                ...
                <div className="reveal w-full max-w-[420px] relative z-10 mt-8">
                    <div className="bg-white/80 backdrop-blur-xl border border-gray-100 shadow-2xl shadow-emerald/[0.04] rounded-3xl p-6 md:p-8">
                        ...
                        {error && (
                            <div className="animate-fade-in border border-red-200 bg-red-light text-red-dark px-4 py-3 mb-5 text-sm text-center rounded-xl font-medium">
                                {error}
                            </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex justify-end mt-2">
                                    <Link href="/forgot-password" className="text-xs text-emerald font-semibold hover:text-emerald-hover transition-colors">
                                        Forgot password?
                                    </Link>
                                </div>
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="group w-full bg-emerald hover:bg-emerald-hover text-white font-semibold text-sm py-3 rounded-xl transition-all duration-200 disabled:opacity-50 shadow-md active:scale-[0.99] mt-2 flex items-center justify-center gap-2"
                            >
