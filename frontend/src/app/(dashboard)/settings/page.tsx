        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="settings-section fade-in-up">
                ...
                <form onSubmit={saveProfile}>
                    <div className="form-group">
                        ...
                        <input type="text" id="fullName" className="form-input" value={profile.fullName} onChange={handleProfileChange} required />
                    </div>
                    <div className="form-group">
                        <label className="form-label" htmlFor="email">Email Address</label>
                        <input type="email" id="email" className="form-input" value={profile.email} onChange={handleProfileChange} required />
                    </div>
                    <div className="form-group">
                        <label className="form-label" htmlFor="phone">Phone Number (Optional)</label>
                        <input type="tel" id="phone" className="form-input" value={profile.phone} onChange={handleProfileChange} />
                    </div>
            ...
            <div className="settings-section danger-zone fade-in-up stagger-4">
                ...
                <div style={{ display: 'flex', gap: 'var(--space-md)', flexWrap: 'wrap' }}>
                    <Button variant="outline" onClick={handleClearData}>Clear All Data</Button>
